...
#define PREHEAT_TIME_BED_MS 15000
...
#define HOMING_BUMP_MM      { 5, 5, 2, 5, 5, 5, 5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
 ...
 */
  ...
  #define E1_HYBRID_THRESHOLD     200
  #define E2_HYBRID_THRESHOLD     200
  #define E3_HYBRID_THRESHOLD     200
